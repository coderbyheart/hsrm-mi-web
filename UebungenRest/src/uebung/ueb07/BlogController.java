	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (!user.isLoggedIn()) {
			...
			if (user.isLoggedIn()) {
				...
				rd = request.getRequestDispatcher("/ueb07-2/listblogs.jsp");
			} else {
				rd = request.getRequestDispatcher("/ueb07-2/login.jsp");
			}
		} else {
			// Logout
			...
			// Eintrag hinzufügen
				...
				rd = request.getRequestDispatcher("/ueb07-2/addblog.jsp");
			}
